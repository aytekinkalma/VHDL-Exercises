...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {urun_hazir}];  # "LD0"
set_property PACKAGE_PIN T21 [get_ports {para_ustu_out}];  # "LD1"
set_property PACKAGE_PIN U22 [get_ports {para_in}];  # "LD2"
...
## ---------------------------------------------------------------------------- 
##set_property PACKAGE_PIN F22 [get_ports {para_in  }[;  # "SW0"
set_property PACKAGE_PIN G22 [get_ports {para[0] }];  # "SW1"
set_property PACKAGE_PIN H22 [get_ports {para[1]}];  # "SW2"
set_property PACKAGE_PIN F21 [get_ports {para[2]}];  # "SW3"
set_property PACKAGE_PIN H19 [get_ports {para[3]}];  # "SW4"
set_property PACKAGE_PIN H18 [get_ports {para[4]}];  # "SW5"
